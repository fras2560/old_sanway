...
<tr>
		...
		<p id="navigation">
		 			<a href="home.php">Home</a> > <a href="team.php">Team Changes</a> > <a href="teamAddPlayerForm.php">Select Player to Add</a> > Added Player
		</p>
	</div>
	<h1>Added Player</h1>
...
<?php
$d->insertPlayer($_SESSION['team_id']);
header("Location: teamAddPlayerForm.php");
?>
