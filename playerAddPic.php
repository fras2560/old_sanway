...
<body id='homebody' style="padding: 0px; margin: 0px; margin-top: 0px;">
	<div id="banner">
		...
		<p id="navigation">
		 			<a href="home.php">Home</a> > <a href="player.php">Player Changes</a> > <a href="playerAddPicForm.php">Select Picture</a> > Added Player Picture
		</p>
	</div>
	<h1>Player Add Pic</h1>
