...
<body id='homebody' style="padding: 0px; margin: 0px; margin-top: 0px;">
 ...
 <html>
    <h2>Player</h2>
     <h3><a href="playerJoinForm.php">Want To Join?</a></h3>
     <table border = 0, cellpadding = 10>
    <tr>
	<td><a href="player.php">Player Changes</a></td>
    </tr>
    </table>
   
    
    <h2>Team</h2>
    <h3><a href="createTeamForm.php">Want To Start A Team?</a></h3>
    <table border = 0, cellpadding = 10>
    <tr>
  	<td><a href="team.php">team Changes</a></td>
  	</tr>
	</table>
