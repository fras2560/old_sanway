...
<tr>
		...
		<p id="navigation">
			<a href="home.php">Home</a> > <a href="championshipSelectForm.php">Championship Select Year</a> > Championship Display
		</p>
	</div>
	<h1>Home Page</h1>
