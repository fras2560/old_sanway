...
<title>Sanway Player Changes</title>
</head>
<body id='homebody' style="padding: 0px; margin: 0px; margin-top: 0px;">
	<div id="banner">
		...
		<p id="navigation">
		 			<a href="home.php">Home</a> > Player Changes
		</p>
	</div>
...
<html>
  ...
  <body>
    ...
    <tr>
    <td><a href="playerAddPicForm.php">Add Player Picture</a></td>
    <td><a href="playerUpdateForm.php">Update Player Profile</a></td>
    </tr>
    </table>
