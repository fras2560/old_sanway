...
<tr>
		...
		<p id="navigation">
		 			<a href="home.php">Home</a> > <a href="team.php">Team Changes</a> > <a href="teamCutPlayerForm.php">Select Player to Cut</a> > Cut Player
		</p>
	</div>
	<h1>Cut Player</h1>
...
?>
<?php
$d->cutPlayer($_SESSION['team_id']);
header("Location: teamCutPlayerForm.php");
