...
<tr>
		...
		<p id="navigation">
		 			<a href="home.php">Home</a> > <a href="team.php">Team Changes</a> > <a href="teamUpdateForm.php">Team Update Form</a> > Team Update
		</p>
	</div>
	<h1>Team Update</h1>
...
?>
<?php
$team_id=$d->getTeamId($_SESSION['team_name']);
$d->updateTeam($team_id);
?>
